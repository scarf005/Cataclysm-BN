...
public:
    mapbuffer_abs_tile_with_vehicle_view(
...
public:
    ...
    auto submaps() const -> std::span<const mapbuffer_abs_submap_view> { return submaps_; }
...
public:
    ...
    auto get_submap_view(const tripoint_abs_sm& p) const
        -> std::optional<mapbuffer_abs_submap_view>;
    auto get_omt_view(const tripoint_abs_omt& p) const -> std::optional<mapbuffer_abs_omt_view>;
...
public:
    ...
    auto get_abs_tile(const tripoint_abs_ms& p, mapbuffer_lookup_options options = {})
        -> std::optional<mapbuffer_abs_tile_view>;
    auto get_abs_tile_with_vehicle(const tripoint_abs_ms& p, mapbuffer_lookup_options options = {})
        -> std::optional<mapbuffer_abs_tile_with_vehicle_view>;
    auto get_abs_submap_view(const tripoint_abs_sm& p, mapbuffer_lookup_options options = {})
        -> std::optional<mapbuffer_abs_submap_view>;
    auto get_abs_omt_view(const tripoint_abs_omt& p, mapbuffer_lookup_options options = {})
    ...
    auto get_ter(const tripoint_abs_ms& p, mapbuffer_lookup_options options = {})
        -> std::optional<ter_id>;
    auto set_ter(const tripoint_abs_ms& p, ter_id terrain, mapbuffer_lookup_options options = {})
        -> bool;

    auto get_furn(const tripoint_abs_ms& p, mapbuffer_lookup_options options = {})
    ...
    auto move_cost(const tripoint_abs_ms& p, mapbuffer_lookup_options options = {})
        -> std::optional<int>;
    auto passable(const tripoint_abs_ms& p, mapbuffer_lookup_options options = {})
        -> std::optional<bool>;
    auto valid_move(
    ...
    auto water_from(const tripoint_abs_ms& p, mapbuffer_lookup_options options = {})
        -> detached_ptr<item>;
