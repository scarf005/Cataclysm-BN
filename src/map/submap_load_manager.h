...
public:
     ...
     */
    virtual void on_submap_loaded(const tripoint_abs_sm& pos, const dimension_id& dim_id) = 0;
     ...
     */
    virtual void on_submap_unloaded(const tripoint_abs_sm& pos, const dimension_id& dim_id) = 0;
};
...
public:
     ...
     */
    auto is_in_simulated_set(const dimension_id& dim_id, const point_abs_sm& pos) const noexcept
        -> bool {
        return prev_simulated_.contains({dim_id, pos});
    }
    auto is_in_simulated_set(
        const dimension_id& dim_id, const tripoint_abs_sm& pos) const noexcept {
