...
rng_deterministic_task_scope::rng_deterministic_task_scope( const unsigned int seed )
    : old_has_task_engine_( tl_has_task_engine ), old_task_engine_( tl_task_engine ),
      old_has_task_context_( tl_has_task_context ), old_task_context_seed_( tl_task_context_seed ),
